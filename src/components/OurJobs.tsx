  ...
  return (
    ...
    >
      <article className="text-center lg:mb-14 ">
        <h2 className="text-[18px] mt-20 2xl:text-[24px] font-bold">
          Nue
          <span className="border-t-4 border-gradient-violet pt-2">
            stros trab
          </span>
          ajos
        </h2>
        <p
          className={`mt-2 px-8 py-2 text-[12px] 2xl:text-[16px] ${poppins.className}`}
        >
          Algunos servicios desarrollados para nuestros socios
        </p>
      </article>
