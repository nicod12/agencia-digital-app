  ...
  return (
    ...
    >
      <h2 className="text-black text-center lg:text-start lg:ml-[350px] font-bold mb-12 2xl:mb-24 2xl:text-[26px]">
        <span className="text-[#5B47C0] pt-2 border-t-4 border-black">
          Para quién es
        </span>{" "}
        nuestro servicio?
      </h2>
      <div className="px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mx-auto lg:w-[70%] xl:w-[80%] 2xl:w-[70%]">
        <div className="bg-[#121212] w-full mx-auto py-12 px-6 rounded-lg shadow-lg mt-12 h-56 relative">
          ...
          <h2 className="text-center text-[15px] 2xl:text-[20px] font-bold">
            Empresas
          </h2>
          <p
            className={`text-center ${poppins.className} text-[10px] 2xl:text-[12px] mt-4`}
          >
            Pequeñas y medianas empresas que desean aumentar las ventas en
            internet
          </p>
        </div>
        ...
        <div className="bg-[#121212] w-full mx-auto py-12 px-6 rounded-lg shadow-lg mt-12 h-56 relative">
          ...
          <p
            className={`text-center ${poppins.className} text-[10px] 2xl:text-[12px] mt-4`}
          >
            Empresarios que desean escalar sus ventas y destacar su empresa en
            el mercado
          </p>
        </div>
        ...
        <div className="bg-[#121212] w-full mx-auto py-12 px-6 rounded-lg shadow-lg mt-12 h-56 relative">
          ...
          <p
            className={`text-center ${poppins.className} text-[10px] 2xl:text-[12px] mt-4`}
          >
            Influenciadores digitales que desean utilizar sus redes sociales
            como un negocio de ventas
          </p>
        </div>
      </div>
