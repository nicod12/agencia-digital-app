...
const MainContainer = () => {
  ...
  return (
    ...
    >
      <div className="max-w-auto w-auto lg:max-w-screen-lg rounded">
        <article className="flex flex-col lg:flex-row lg:w-full lg:px-24 2xl:px-0 justify-center">
          <div className="sm:flex md:flex md:items-center lg:flex lg:items-center">
            <div className="px-6 py-4 mt-0 sm:w-full md:w-full lg:mt-4 lg:w-full">
              <h1 className="font-bold text-xl xl:text-2xl mb-8">
                Generamos soluciones que orquestan resultados para tu negocio
              </h1>
              <p
              ...
              <div className="flex flex-col-reverse lg:flex-col">
                <button className="bg-gradient-to-r hover:bg-gradient-to-r from-[#664BC0] hover:from-[#5a5697] to-[#B155B5] hover:to-[#98439b] hover:transition hover:duration-500 hover:text-slate-300 uppercase py-3 px-8 text-[15px] xl:text-[18px] rounded mt-8 lg:mt-4 lg:w-[40%]">
                  Agendar un meeting
                </button>
                <section className="mt-4 lg:mt-20 xl:mt-20 2xl:mt-20 py-4 flex flex-col md:flex-row lg:flex-row gap-7">
                  ...
                  <div className="flex items-center">
                    ...
                    <h2 className="ml-2">Más Diseño</h2>
                  </div>
                </section>
              </div>
            </div>
