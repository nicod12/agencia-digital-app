  ...
  return (
    <>
      ...
      <section className="m-4">
        ...
        <section className={`grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full sm:w-full md:w-[80%] md:mx-auto 2xl:w-[70%] mt-8 ${poppins.className}`}>
